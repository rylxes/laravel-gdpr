...
class DataErasedTest extends TestCase
{
    #[Test]
    public function it_has_correct_constructor_parameters(): void
    {
        $reflection = new ReflectionClass(DataErased::class);
        ...
        $this->assertEquals('erasedModels', $params[3]->getName());
    }
    #[Test]
    public function it_has_readonly_properties(): void
    {
        ...
        $this->assertTrue($reflection->getProperty('erasedModels')->isReadOnly());
    }
    #[Test]
